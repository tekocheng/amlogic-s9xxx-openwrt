...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        jshn kmod-brcmfmac kmod-brcmutil kmod-cfg80211 kmod-mac80211 kmod-fs-btrfs libjson-script liblucihttp \
        liblucihttp-lua losetup lsattr lsblk lscpu mkf2fs mount-utils openssh-sftp-server openssl-util parted \
        ...
        wpad-basic wpa-cli wwan xfs-fsck xfs-mkfs xz xz-utils ziptool zoneinfo-asia zoneinfo-core zstd \
        \
