...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        wpad-basic wwan xfs-fsck xfs-mkfs xz xz-utils ziptool zoneinfo-asia zoneinfo-core zram-swap zstd \
        \
        ...
        \
        luci-app-amlogic luci-app-irqbalance luci-app-tailscale-community \
        \
        ${config_list} \
        "
